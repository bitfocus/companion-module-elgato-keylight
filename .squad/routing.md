...
| API integration, polling, variables            | Wash        | Elgato API handling, device polling, state updates           |
| Actions, feedbacks, presets, config            | Kaylee      | New actions, feedback definitions, module settings UI        |
| Tests, quality, edge cases                     | Zoe         | Validation strategy, coverage gaps, API and polling edges    |
